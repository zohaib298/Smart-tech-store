    ...
    <div class="p-2 relative">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            @foreach ($products as $item)
                <a href="/singleproduct/{{ $item['id'] }}" class="p-3 text-center h-[260px]">
...
<div class="container mx-auto my-10">
    ...
    <div class="p-2 relative">
        ...
        <div class="flex gap-4 overflow-x-auto scrollbar-hide sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:overflow-visible">
            <a href="/company/DELL" class="min-w-[80%] sm:min-w-0 p-3">
            ...
            <a href="/company/LENOVO" class="min-w-[80%] sm:min-w-0 p-3">
                <img class="h-[200px] sm:h-[250px] lg:h-[300px] w-full object-cover rounded"
            ...
            <a href="/company/HP" class="min-w-[80%] sm:min-w-0 p-3">
                <img class="h-[200px] sm:h-[250px] lg:h-[300px] w-full object-cover rounded"
    ...
    <div class="bg-gray-100 w-full p-5 rounded">
        <img src="https://smarttechstore.com/cdn/shop/files/van-car-delivery-truck-computer-icons-car-0d26b6efb5a98155b76b7158dc0934a7.png?v=1766216479&width=200" 
             alt="" class="mx-auto h-16 sm:h-20 object-contain">
    ...
    <div class="bg-gray-100 w-full p-5 rounded">
        <img src="https://smarttechstore.com/cdn/shop/files/product-return-policy-money-back-guarantee-computer-icons-return-51e31906349ec7a0ecff97ba59a11d84.png?v=1766216671&width=200" 
             alt="" class="mx-auto h-16 sm:h-20 object-contain">
        <p class="text-center mt-4 text-sm sm:text-base leading-relaxed">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-[95%] sm:w-[90%] lg:w-[80%] mx-auto my-20">
    <div class="bg-white shadow-xl rounded-2xl flex items-center justify-center h-[180px] sm:h-[220px] lg:h-[250px] p-6">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Lazada_Logo.svg/2560px-Lazada_Logo.svg.png" class="max-h-full object-contain">
    </div>
    <div class="bg-white shadow-xl rounded-2xl flex items-center justify-center h-[180px] sm:h-[220px] lg:h-[250px] p-6">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Shopee.svg/2560px-Shopee.svg.png" class="max-h-full object-contain">
    </div>
    <div class="bg-white shadow-xl rounded-2xl flex items-center justify-center h-[180px] sm:h-[220px] lg:h-[250px] p-6">
        <img src="https://upload.wikimedia.org/wikipedia/en/thumb/a/a9/TikTok_logo.svg/2560px-TikTok_logo.svg.png" class="max-h-full object-contain">
    </div>
</div>
        </div>
